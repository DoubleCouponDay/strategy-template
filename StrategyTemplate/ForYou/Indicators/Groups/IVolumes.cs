...
namespace StrategyTemplate.ForYou.Indicators.Groups
{
    public interface IVolumes
    {
        ...
        /// <returns></returns>
        ITaLibOutput<IList<decimal>> ChaikinADLine(Frequency unitType,int historiesLength);
        ...
        /// <returns></returns>
        ITaLibOutput<IList<decimal>> ChaikinADOscillator(Frequency unitType,int historiesLength,int fastPeriod = 3, int slowPeriod = 10);
        ...
        /// <param name="historiesLength"></param>
        /// <returns></returns>
        ITaLibOutput<IList<decimal>> OnBalanceVolume(Frequency unitType,int historiesLength);
    }
}
