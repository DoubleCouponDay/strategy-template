...
namespace StrategyTemplate.ForYou.Indicators.Groups
{
    public interface IVolatilities
    {
        ...
        /// <returns></returns>
        ITaLibOutput<IList<decimal>> AverageTrueRange(Frequency unitType,int historiesLength, int timePeriod = 14);
        ...
        /// <param name="timePeriod"></param>
        /// <returns></returns>
        ITaLibOutput<IList<decimal>> NormalizedAverageTrueRange(Frequency unitType,int historiesLength, int timePeriod = 14);
        ...
        /// <param name="historiesLength"></param>
        /// <returns></returns>
        ITaLibOutput<IList<decimal>> TrueRange(Frequency unitType,int historiesLength);
    }
}
